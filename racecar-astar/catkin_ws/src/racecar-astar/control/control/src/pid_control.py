...
from control.cfg import pos_PIDConfig, ang_PIDConfig, pos_loco_PIDConfig, ang_loco_PIDConfig
...
class Robot_PID():
    def __init__(self):
        ...
        self.cmd_msg = None
        self.timer = rospy.Timer(rospy.Duration(0.1), self.cmd_loop)
    ...
    def cmd_loop(self, event):
        ...
        if self.auto and self.cmd_msg is not None:
